...
export default function Leaderboard() {
  ...
  const getRankStyle = (index) => {
    switch (index) {
      case 0:
        return "text-yellow-400 font-bold bg-yellow-500/10 border-yellow-500/20"; // Gold
      case 1:
        return "text-gray-300 font-bold bg-gray-500/10 border-gray-500/20"; // Silver
      case 2:
        return "text-amber-600 font-bold bg-amber-500/10 border-amber-500/20"; // Bronze
      default:
        return "text-gray-400 font-medium border-transparent";
    }
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between p-6 border-b border-gray-800 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Global ranking based on coding platform activity & ratings.
          </p>
        </div>
          ...
          <div className="border border-gray-700 rounded-xl overflow-hidden bg-gray-800 overflow-x-auto">
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="text-gray-400 border-b border-gray-700 bg-gray-900/50">
                <tr>
                  <th className="py-4 px-6 font-medium w-20 text-center">
                    Rank
                  </th>
                ...
                {filteredLeaderboard.map((student, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 text-center">
                      <div
                        className={`inline-flex items-center justify-center w-8 h-8 rounded-full border ${getRankStyle(index)}`}
                      >
                        {index + 1}
                      </div>
                    </td>
